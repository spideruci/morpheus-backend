...
def test_adding_tests_to_table():
    ...
    test_id1 = test_db_handler.add_test_method(0, 0, test_method['method_name'], test_method['class_name'])
    test_id2 = test_db_handler.add_test_method(0, 1, test_method['method_name'], test_method['class_name'])

    test_id3 = test_db_handler.add_test_method(1, 0, test_method['method_name'], test_method['class_name'])
    test_id4 = test_db_handler.add_test_method(1, 1, test_method['method_name'], test_method['class_name'])
